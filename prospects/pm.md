...
│   PM    │    Source: Context file + Decision history
...
- Input: Decision issue, context file, decision history
- Process: Match decision to context or ask human
- Output: Answer via bd comment, decision log
- Metrics: Decisions answered, escalation rate, confidence distribution
...
The Miner asks: "[decision question]"
...
3. Allow the hook to respawn Miner
...
│                                                                │
│      Decision issue closed. Miner can resume.                  │
│      PM Agent exiting.                                         │
│                                                                │
╰────────────────────────────────────────────────────────────────╯
```
